/*
 * @Author: 陈祖康
 * @Date: 2021-03-09 14:28:57
 * @LastEditors: 陈祖康
 * @LastEditTime: 2021-03-09 15:30:19
 * @Description: 
 * @Props: 
 * @Emit: 
 */
/**
 *
 * 给定不同面额的硬币coins和一个总金额amount编写一个函数来计算可以凑成总金额所需的最少的硬币个数如果没有任何一种硬币组合能组成总金额,返回-1
你可以认为每种硬币的数量是无限的。
 ...
 * @param {number} amount
 * @return {number}
 * fill() 填充数组，用Infinity正无穷填充方便之后取最小值
 */
